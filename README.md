...
deploy e instalação, etc. Crie um único arquivo COMMENTS.md no
...
Recomendamos o uso do framework React no front-end e NodeJS com Express no back-end,
pois essa é a stack que mais utilizamos. Além disso evite o uso de typescript,
pois a nossa base de código utiliza javascript vanilla e é importante para nós 
entender como você organiza e implementa o código considerando esse fator.
